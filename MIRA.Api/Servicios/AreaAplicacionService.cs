...
public class AreaAplicacionService : IAreaAplicacionService
{
    private readonly IAreaAplicacionRepository _repository;

    public AreaAplicacionService(IAreaAplicacionRepository repository)
    {
    ...
    public async Task<bool> UpdateAsync(int id, AreaAplicacion entity)
    {
